...
ffviss2   <- nzo_sf %>% filter(SITE_NAME=="viss2")
...
save(jff_comb, file="rdata/jff_comb_v1.2.RData")
sf::st_write(jff_comb, "shape/jff_comb_v1.2.shp")
load(file="rdata/jff_comb_v1.2.RData")
